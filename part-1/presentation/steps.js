...
var STEPS = [{
    dir: 'intro',
    subSteps: [
        {name: 'setAndShowSidePanelImg', options: {img: 'intro/modules-src-path.svg', imgOffset: {x:10}}},
        ...
        {name: 'showTextOnSidePanel', options: {text: 'platformsList', offset: {x: 0, y: 0}}},
        'resizeAndHideSidePanel',
        {name: 'showCodeOnSidePanel', options: {text: 'firstCodeExample', offset: {x: 0, y: 0}}},
        'resizeAndHideSidePanel',
        'gotoStep'
    ]
},{
    ...
    subSteps: [
        ...
        'showDefaultPart',
        'showPartA',
        {name: 'resizePanelAndSetImg', options: {img: '0/mounting-scheme-1-small.svg', imgOffset: {x: 200, y: 200}}},
        {name: 'exchangePanelImgs', options: {img: '0/mounting-scheme-1-big.svg', imgOffset: {x: 200, y: 200}}},
        'resizeAndHideSidePanel',
        {name: 'showTextOnSidePanel', options: {text: 'mountingDescription0', offset: {x: 200, y: 200}}},
        'resizeAndHideSidePanel',
        {name: 'resizePanelAndSetImg', options: {img: '0/jsx-to-vdom.svg', imgOffset: {x: 200, y: 200}}},
        'resizeAndHideSidePanel',
        {name: 'showFunnyFactOnSidePanel', options: {text: 'validateDOMNesting', offset: {x: 200, y: 200}}},
        'resizeAndHideSidePanel',
        'backToAllScheme',
        'gotoStep'
    ]
    ...
    subSteps: [
        ...
        'showOverlay',
        'showDefaultPart',
        {name: 'resizePanelAndSetImg', options: {img: '1/communication-channel.svg', imgOffset: {x: 0, y: 0}}},
        {name: 'exchangePanelImgs', options: {img: '1/transaction.svg', imgOffset: {x: 0, y: 0}}},
        'resizeAndHideSidePanel',
        {name: 'showTextOnSidePanel', options: {text: 'transactionSteps', offset: {x: 0, y: 0}}},
        'resizeAndHideSidePanel',
        {name: 'showTextOnSidePanel', options: {text: 'transactionsInReact', offset: {x: 0, y: 0}}},
        'resizeAndHideSidePanel',
        {name: 'showCodeOnSidePanel', options: {text: 'transactionCodeExample', offset: {x: 0, y: 0}}},
        'resizeAndHideSidePanel',
        'showPartA',
        'backToAllScheme',
        'gotoStep'
    ...
    subSteps: [
        ...
        'showOverlay',
        'showDefaultPart',
        {name: 'showCodeOnSidePanel', options: {text: 'transactionReactReconcileTransaction', offset: {}}},
        'resizeAndHideSidePanel',
        'showPartA',
        'backToAllScheme',
        'gotoStep'
    ...
    subSteps: [
        ...
        'showOverlay',
        'showDefaultPart',
        {name: 'showCodeOnSidePanel', options: {text: 'willUpdate3', offset: {}}},
        'resizeAndHideSidePanel',
        'showPartA',
        'backToAllScheme',
        'gotoStep'
    ...
    subSteps: [
        ...
        'showOverlay',
        'showDefaultPart',
        {name: 'showCodeOnSidePanel', options: {text: 'setHtml4', offset: {}}},
        'resizeAndHideSidePanel',
        'showPartA',
        'backToAllScheme',
        'gotoStep'
    ...
    subSteps: [
        ...
        'resizeAndHideSidePanel',
        {name: 'showTextOnSidePanel', options: {text: 'mountingScheme6', offset: {}}},
        'resizeAndHideSidePanel',
        'backToAllScheme',
        'gotoStep'
    ]
    ...
    subSteps: [
        ...
        'showOverlay',
        'showDefaultPart',
        {name: 'showCodeOnSidePanel', options: {text: 'setState8', offset: {}}},
        'resizeAndHideSidePanel',
        'showPartA',
        'backToAllScheme',
        'gotoStep'
    ...
    subSteps: [
        ...
        'showDefaultPart',
        'showPartA',
        {name: 'showFunnyFactOnSidePanel', options: {text: 'synthEvent9', offset: {}}},
        'resizeAndHideSidePanel',
        {name: 'showCodeOnSidePanel', options: {text: 'fakeEventCode9', offset: {}}},
        'resizeAndHideSidePanel',
        {name: 'resizePanelAndSetImg', options: {img: '9/set-state-update-start.svg', offset: {}}},
        'resizeAndHideSidePanel',
        {name: 'showTextOnSidePanel', options: {text: 'setStateScheme9', offset: {}}},
        'resizeAndHideSidePanel',
        'backToAllScheme',
        'gotoStep'
    ]
    ...
    subSteps: [
        ...
        'showOverlay',
        'showDefaultPart',
        {name: 'showCodeOnSidePanel', options: {text: 'nestedTransactions10', offset: {}}},
        'resizeAndHideSidePanel',
        'showPartA',
        'backToAllScheme',
        'gotoStep'
    ...
    subSteps: [
        ...
        'showOverlay',
        'showDefaultPart',
        {name: 'showTextOnSidePanel', options: {text: 'updateMethod11', offset: {}}},
        'resizeAndHideSidePanel',
        'showPartA',
        'backToAllScheme',
        'gotoStep'
    ...
    subSteps: [
        ...
        'showOverlay',
        'showDefaultPart',
        {name: 'showCodeOnSidePanel', options: {text: 'shouldUpdate12', offset: {}}},
        'resizeAndHideSidePanel',
        'showPartA',
        'backToAllScheme',
        'gotoStep'
    ...
    subSteps: [
        ...
        'resizeAndHideSidePanel',
        {name: 'showCodeOnSidePanel', options: {text: 'updateConfig14', offset: {}}},
        'resizeAndHideSidePanel',
        {name: 'showCodeOnSidePanel', options: {text: 'domChildrenOperation14', offset: {}}},
        'resizeAndHideSidePanel',
        'backToAllScheme',
        'gotoStep'
    ]
